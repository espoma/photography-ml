...
**Today (May 27, 2026):**
- ✅ Rate limiting implemented using `slowapi` (per-IP, 10 uploads/hour) and tested locally
- Note: This is an IP-based/global limiter because there is no authentication yet; when auth is added we'll switch to a per-user limiter.
